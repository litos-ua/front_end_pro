    ...
    return (
        <div className="col-md-4" key={num}>
          <div className="card" style={{ height: '100%' }}>
            <img src={`./images/${num}.jpg`} className="card-img-top" alt={`Image ${num}`} style={{ objectFit: 'cover', height: '200px' }} />
            <div className="card-body" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', height: '100%', backgroundColor: '#dded80' }}>
