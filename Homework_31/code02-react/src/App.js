...
const App = () => {
    ...
    const createImage = (num, index) => {
        return (
            <div className="col-md-4" key={`${num}_${index}`}>
    ...
    return (
        <div className="text-center">
            ...
            <div id="imageContainer" className="container mt-5">
                <div className="row">
                    {[...Array(numOfPictures)].map((_, index) =>
                        createImage(getRandomImageNumber(1, numOfPictures), index)
                    )}
                </div>
            </div>
        </div>
