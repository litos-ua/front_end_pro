...
та масив з даними humanProperty. Конструктор класа, приймає параметри:
 ...
 У класі існує один метод showHumanoid, який виводить у консоль інформацію про людину.
  ...
  * Присвоєння власника assignOwner - метод приймає екземпляр класу 
    Humanoid, та зберігає екземпляр класу Humanoid у полі owner. Якщо вік 
    меньше 18 років, виводити у консоль повідомлення: "The owner 
    of the car cannot be a person under 18.". Якщо поле вже заповнено,
    воно не змінюється, у консоль виводиться повідомлення: "The car already
    has an owner." Одна людина може бути власником декількох авто.
  * Присвоєння власника owner - попередній метод продубльовано як сеттер.
